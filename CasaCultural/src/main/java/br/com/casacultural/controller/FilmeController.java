...
public String salvarFilme(@ModelAttribute Filme filme) {
    if (filme.getSinopse() != null && filme.getSinopse().length() > 500) {
        // Redireciona de volta ao formulário com mensagem de erro via query string (exemplo simples)
        return "redirect:/form-filme.html?erro=sinopseMuitoLonga";
    }
